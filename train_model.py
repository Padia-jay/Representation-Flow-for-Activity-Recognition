...
if args.system == 'minikinetics':
    ...
    val = 'E:/representation-flow-cvpr19-master/representation-flow-cvpr19-master/data/kinetics/minikinetics_val.json'
    root = 'E:/representation-flow-cvpr19-master/representation-flow-cvpr19-master/data/kinetics'
    from minikinetics import MK
...
if args.system == 'kinetics':
    train = 'E:/representation-flow-cvpr19-master/representation-flow-cvpr19-master/data/kinetics/kinetics_train.json'
    val = 'E:/representation-flow-cvpr19-master/representation-flow-cvpr19-master/data/kinetics/kinetics_val.json'
    root = 'E:/representation-flow-cvpr19-master/representation-flow-cvpr19-master/data/kinetics'
...
log_path = os.path.join('E:/representation-flow-cvpr19-master/representation-flow-cvpr19-master/logs',log_name)
os.mkdir(log_path)
